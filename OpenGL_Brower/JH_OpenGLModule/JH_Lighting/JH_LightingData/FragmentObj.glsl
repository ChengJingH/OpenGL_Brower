...
void main()
{
    ...
    //漫反射光
    lowp vec3 diffuseLightVector = normalizeVector(lightColor - worldPosition);
    ...
    lowp vec3 specularLightVector = reflect(normalizeVector(lightColor - worldPosition), varyNormal); //reflect函数求反射光
